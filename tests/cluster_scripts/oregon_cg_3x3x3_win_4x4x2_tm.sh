...
#SBATCH --job-name=oregon_cg_3x3x3_win_4x4x2_tm
...
time mpiexec --bind-to core -np $SLURM_NTASKS julia /leonardo/home/userexternal/tcausin0/SIP_package/tests/cluster_scripts/template_matching_parallel_cluster2.jl $fn $cg1 $cg2 $cg3 $win1 $win2 $win3 $n_mergers

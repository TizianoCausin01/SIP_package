...
@info "type received dict $(typeof(array_buffer))"
@info "length received dict $(length(array_buffer))"
...
@info "worker $(rank) received start = $(start)"				

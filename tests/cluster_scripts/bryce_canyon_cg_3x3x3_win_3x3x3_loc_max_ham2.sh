...
#SBATCH --job-name=bryce_canyon_cg_3x3x3_win_3x3x3_loc_max_ham2
...
time mpiexec --bind-to core -np $SLURM_NTASKS julia /leonardo/home/userexternal/tcausin0/SIP_package/tests/cluster_scripts/loc_max_ham_parallel_cluster.jl $fn $cg1 $cg2 $cg3 $win1 $win2 $win3 $ham_dist

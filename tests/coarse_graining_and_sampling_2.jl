...
begin
	...
	tot_iterations = Dict{Int, Array{Bool, 3}}() # different coarse-graining iterations
	tot_counts = Dict{Int, Dict{Vector{Bool}, Int}}() # counts of patches
	tot_sorted_counts = Vector{Vector{Pair{Vector{Bool}, Int}}}() # sorted count of patches
	...
	for i = 1:5
		...
		new_iteration = zeros(Bool,new_dim) # preallocation of current iteration array
